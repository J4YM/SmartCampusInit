...
/// "Print" action.
enum AdmissionSlipStatus { ready, printing, printed }

/// Full-screen preview of an admission slip, shown AFTER it has already
/// been written to the database — the host app's confirmation popup (shown
/// before this screen is pushed) is what actually performs the write, so by
/// the time this renders the record already exists. This screen is purely
/// presentational: [onDone] just navigates away, and [onPrint] only prints.
///
...
class AdmissionSlipPreviewScreen extends StatefulWidget {
  ...
  /// Tapped from [AdmissionSlipStatus.ready] ("Done") or reached
  /// automatically after the print sequence finishes — returns to the
  /// kiosk's idle scan screen, ready for the next person.
...
class _ActionArea extends StatelessWidget {
  ...
  /// Navigates away — the slip has already been written, so this is just
  /// "I'm finished looking at this".
  final VoidCallback onDone;

  /// Starts the print animation sequence; sole purpose is printing, no
  /// database write is attached.
