...
extension AttendanceStatusX on AttendanceStatus {
  ...
  Color foreground(BuildContext context) {
    switch (this) {
      case AttendanceStatus.present:
        return ParentPortalColors.presentFg(context);
      case AttendanceStatus.absent:
        return ParentPortalColors.absentFg(context);
      case AttendanceStatus.late:
        return ParentPortalColors.lateFg(context);
      case AttendanceStatus.excused:
        return ParentPortalColors.excusedFg(context);
    }
  }
  ...
  Color background(BuildContext context) {
    switch (this) {
      case AttendanceStatus.present:
        return ParentPortalColors.presentBg(context);
      case AttendanceStatus.absent:
        return ParentPortalColors.absentBg(context);
      case AttendanceStatus.late:
        return ParentPortalColors.lateBg(context);
      case AttendanceStatus.excused:
        return ParentPortalColors.excusedBg(context);
    }
  }
...
class AttendanceEntry {
  ...
  /// see ParentPortalRepository.fetchAttendance's doc comment).
