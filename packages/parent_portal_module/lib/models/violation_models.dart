...
/// parent portal shows (the staff-side Discipline Officer module further
...
extension ViolationCategoryX on ViolationCategory {
  ...
  Color foreground(BuildContext context) => this == ViolationCategory.minor
      ? ParentPortalColors.minorFg(context)
      : ParentPortalColors.majorFg(context);

  Color background(BuildContext context) => this == ViolationCategory.minor
      ? ParentPortalColors.minorBg(context)
      : ParentPortalColors.majorBg(context);
...
/// One row from `student_violations`, reduced to what the parent portal
/// needs to display.
