...
/// `ParentPortalRepository.submitGoodMoralRequest`) already accepts, so no
...
class _GoodMoralRequestPageState extends State<GoodMoralRequestPage> {
  ...
  InputDecoration _blankDecoration(BuildContext context) {
    final line = ParentPortalColors.borderStrong(context);
    return InputDecoration(
      ...
      focusedBorder: UnderlineInputBorder(
        borderSide: BorderSide(color: ParentPortalColors.accent(context)),
      ),
            ...
            child: Form(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: ParentPortalColors.borderStrong(context)),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: ParentPortalSpacing.xl),
                    ...
                    // half-width column.
                    Wrap(
                      spacing: ParentPortalSpacing.xl,
                      runSpacing: 2,
                      children: [
                    ...
                    Wrap(
                      spacing: ParentPortalSpacing.lg,
                      runSpacing: ParentPortalSpacing.sm,
                      children: [
                    ...
                    Row(
                      ...
                      children: [
                        Checkbox(
                          ...
                          activeColor: ParentPortalColors.textPrimary(context),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  height: 1,
                                  color: ParentPortalColors.borderStrong(
                                      context)),
                              const SizedBox(height: 4),
                              Text('Signature of Student',
                                  style: GoogleFonts.inter(
                                    fontSize: 11,
                                    color:
                                        ParentPortalColors.textMuted(context),
                                  )),
                            ],
                          ),
                        ),
                        const SizedBox(width: ParentPortalSpacing.xxl),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(today,
                                  style: GoogleFonts.inter(
                                    fontSize: 13,
                                    color: ParentPortalColors.textPrimary(
                                        context),
                                  )),
                              Container(
                                  height: 1,
                    ...
                    const SizedBox(height: ParentPortalSpacing.xxl),
                    Row(
                      children: [
                        Expanded(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: selected
                        ? ParentPortalColors.textPrimary(context)
                        : ParentPortalColors.borderStrong(context),
                    width: 1.4,
                  ),
                ...
                child: selected
                    ? Icon(Icons.check,
                        size: 12, color: ParentPortalColors.surface(context))
                    : null,
              ),
            ),
