  ...
  Widget build(BuildContext context) {
      ...
      children: [
        Text(
          ...
          style: GoogleFonts.inter(
            ...
            letterSpacing: 0.4,
            color: ParentPortalColors.accent(context),
          ),
        ),
        ...
        const SizedBox(height: ParentPortalSpacing.md + 2),
        Wrap(
          alignment: compact ? WrapAlignment.center : WrapAlignment.start,
          spacing: ParentPortalSpacing.sm,
          runSpacing: ParentPortalSpacing.sm,
          children: [
            _StatChip(
              color: ParentPortalColors.presentFg(context),
              label: '$presentCount Present',
            ),
            _StatChip(
              color: ParentPortalColors.lateFg(context),
    ...
    return PortalSurfaceCard(
      padding: const EdgeInsets.symmetric(
        horizontal: ParentPortalSpacing.xxl,
        vertical: ParentPortalSpacing.xl,
      ),
      child: compact
          ? Column(
              children: [
