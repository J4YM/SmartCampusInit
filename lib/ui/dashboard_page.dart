...
class DashboardPage extends StatefulWidget {
  ...
  /// When set (e.g. opened from Admin Hub), shows a control to pop back.
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  List<StudentRecord> get _filteredRecords {
  ...
  Future<void> _registerStudent() async {
    ...
    final yearLevelUi = _selectedYearLevel;
    ...
    if (rfidNo.isEmpty ||
        ...
        course == null ||
        yearLevelUi == null) {
      _toast('Please complete all required fields before register.');
      return;
    }
    ...
    final yearLevelInt = StudentRecord.yearLabelToInt(yearLevelUi);
  ...
  void _startEditStudent(StudentRecord student) {
    setState(() {
                                  ...
                                  children: [
                                    if (compact) ...[
                                      ...
                                      _textField(
                                        label: 'Section',
                                        hint:
                                            'Must match sections.name for program + year',
                                    ...
                                    _textField(
                                      ...
                                      hint:
                                          'Read-only: first linked parent in Supabase',
                                ...
                                child: Center(
                                  child: Text(
                                    AppEnv.supabaseConfigured
                                        ? 'No students returned for this session. If rows exist in '
                                            'Supabase, allow SELECT for role `anon` on `students` and related '
                                            'tables (see supabase/rls_students_list_anon.sql), then pull to refresh.'
                                        : 'No students loaded (Supabase not configured).',
                                    style: const TextStyle(
